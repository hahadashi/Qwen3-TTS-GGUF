...
INPUT_MODEL = MODEL_DIR / "qwen3_tts_talker.f16.gguf"
OUTPUT_MODEL = MODEL_DIR / f"qwen3_tts_talker.{QUANTIZE_TYPE}.gguf"
...
def main():
    ...
    if not INPUT_MODEL.exists():
        print(f"❌ 找不到输入模型，请先运行 23 脚本生成 f16 模型: {INPUT_MODEL}")
        return
